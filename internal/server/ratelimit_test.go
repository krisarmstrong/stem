...
func TestRateLimiterConcurrency(t *testing.T) {
	...
	rl := server.NewRateLimiter(1000, 1000)
	defer rl.Stop()
...
func BenchmarkRateLimiterAllow(b *testing.B) {
	rl := server.NewRateLimiter(1000000, 1000000) // High limit to avoid rate limiting.
	defer rl.Stop()
...
func BenchmarkRateLimiterMiddleware(b *testing.B) {
	rl := server.NewRateLimiter(1000000, 1000000)
	defer rl.Stop()
