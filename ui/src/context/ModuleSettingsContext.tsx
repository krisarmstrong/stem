...
const defaultModules: ModuleConfig[] = [
  {
    ...
    autoStart: false,
    tests: [
      { id: 'reflect', name: 'Reflect', description: 'Basic packet reflection', enabled: true },
      { id: 'echo', name: 'Echo', description: 'ICMP echo response', enabled: true },
    ],
  },
  {
    name: 'benchmark',
    ...
    tests: [
      ...
      { id: 'reset', name: 'Reset', description: 'Reset recovery time', enabled: false },
    ],
  },
  {
    name: 'servicetest',
  ...
  },
  {
    ...
    autoStart: false,
    tests: [
      { id: 'y1731_delay', name: 'Delay', description: 'Frame delay measurement', enabled: true },
      { id: 'y1731_loss', name: 'Loss', description: 'Frame loss measurement', enabled: true },
      { id: 'y1731_slm', name: 'SLM', description: 'Synthetic loss measurement', enabled: false },
      { id: 'y1731_loopback', name: 'Loopback', description: 'ETH-LB test', enabled: false },
    ],
  },
  {
    name: 'certify',
...
export function ModuleSettingsProvider({ children }: ModuleSettingsProviderProps): ReactElement {
  ...
  const getAllEnabledTests = useCallback((): Array<{ module: string; test: ModuleTest }> => {
